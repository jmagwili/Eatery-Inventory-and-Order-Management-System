...
public class SideBar extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Ingredients", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Categories", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Orders", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Menu", Model_Menu.MenuType.MENU));
//        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
//
...
//        listMenu1.addItem(new Model_Menu("9", "More", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/ate-joys-logo.png"))); // NOI18N
        jLabel1.setText("Ate Joy's Eatery");
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#023517"), 0, getHeight(), Color.decode("#023517"));
        g2.setPaint(g);
